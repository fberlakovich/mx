...
/**
 * Action to clean the MX project
 */
public class MxCleanAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        MxBuildTask.MxBuildListener listener = new MxBuildTask.MxBuildListener() {
            ...
            public void onSuccess() {
                Messages.showInfoMessage(project, "Clean completed successfully", "MX Clean");
            }

            @Override
            public void onFailure(int exitCode) {
                Messages.showErrorDialog(project, "Clean failed with exit code: " + exitCode, "MX Clean");
            }
        };
